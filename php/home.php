<div>
  ...
  <div class='bigblock'>
    <div style='float:left'>
      <a  href='<?php echo $scriptname?>?action=listfiber'>
      <img class='bigblock' src='images/big/fiber.png'>
      </a>
    </div>
    <div class='bigblocklinks'>
	    <div><a  href='<?php echo $scriptname?>?action=listfiber'><img class='bigblocklnk' src='images/big/search24.png'> <span class="lnktxt"><?php te("Find");?></span></a></div>
	    <div><a   href='<?php echo $scriptname?>?action=editfiber&amp;id=new'><img class='bigblocklnk' src='images/big/plus.png'> <span class="lnktxt"><?php te("Add");?></span></a></div>
    </div>
    <div class='bigblockdesc'>
      <div class='bigblocktitle'><?php te("Fiber");?></div>
      <?php te("Manage your Fiber.");?><br>
    </div>
  </div>
