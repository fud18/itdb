...
require("../init.php");
        ...
        //nextstep:
        //0: show import form
        //1: import file and if not successful go to 0 else show imported file and fields, and candidate db objects
        //2: DB insert
...
<?php $sqlTable = "CREATE TABLE IF NOT EXISTS departments(id integer primary key autoincrement,division VARCHAR,name VARCHAR,abbr VARCHAR)";
...
<br />
<br />
<a href='../data/files/contracts_import_template.csv'><img src='../images/xcel2.jpg' height=25 border=0></a> <a href='../data/files/contracts_import_template.csv'>Template</a>
<br />
<br />
</p>
</center>
...
?>
    ...
    <?php
        ...
        echo "<th>ID</th><th>Division</th><th>Name</th><th>Abbreviation</th>\n";
    ?>
    </tr>
	</thead>
	<tbody>
...
if ($nextstep==2) {
	...
	//Add Departments
	foreach ($imlines as $line_num => $departments) {
		if ($line_num==0 && $_POST['skip1st']) {
			continue;
		}

		if (!lineok($departments,$delim))
			continue;

		$cols=explode($delim,$departments);
	...
	$sql=	"INSERT into departments ".
		...
		echo "<center><br><h2>Contracts Data Imported Successfully</h2><br></center>";	
}
