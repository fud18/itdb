...
<br />
<br />
<a href='../data/files/vlans_import_template.csv'><img src='../images/xcel2.jpg' height=25 border=0></a> <a href='../data/files/vlans_import_template.csv'>Template</a>
<br />
<br />
</p>
</center>
...
if ($nextstep==2) {
	...
	// Add vlans Records
	foreach ($imlines as $line_num => $vlans) {
		if ($line_num==0 && $_POST['skip1st']) {
			continue;
		}

		$cols=explode($delim,$vlans);
	...
	$sql=	"INSERT into vlans ".
		...
		echo "<center><br><h2>VLAN Data Imported Successfully</h2><br></center>";	
}
