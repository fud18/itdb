...
while ($r=$sth->fetch(PDO::FETCH_ASSOC)) {
  $i++;
  echo "\n<tr id='trid{$r['id']}'>";
  echo "<td class='editiditm icon edit'><center><a href='$scriptname?action=editfiber&amp;id=".$r['id']."'><img src='../images/edit2.png'></a><a href='../php/delfiber.php?id=".$r['id']."'><img src='../images/delete.png' border=0></a></center></td>";
