...
<script type="text/javascript" src="https://github.com/malsup/blockui/blob/master/jquery.blockUI.js"></script>

<script>
	$(function() {
		$("#locations a").click(function() {
			var page = this.hash.substr(1);
			$.get("locations/"+page+".php",function(gotHtml) {
...
$t=time();
$sql="SELECT * FROM jacks WHERE locationid = '3' OR locationid = '4' $where order by $orderby LIMIT $perpage OFFSET ".($perpage*($page-1));
